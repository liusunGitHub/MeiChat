...
public class MainFragment_old extends BackHandFragment implements OnBackToFirstListener{
    ...
    public static MainFragment_old newInstance() {
        ...
        mBottomBar.setOnTabSelectedListener(new BottomBar.OnTabSelectedListener() {
            ...
            public void onTabSelected(int position, int prePosition) {
                switch (position) {
                    ...
                    case 3:
                        if (mFragment04 == null)
                            mFragment04 = UserFragment.newInstance();
