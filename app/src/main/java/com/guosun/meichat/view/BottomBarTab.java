...
public class BottomBarTab extends FrameLayout {
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.tab_icon_unselect));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.tab_text_unselect));
        }
    }
